...
router.get('/test', async (req, res) => {
    if (req.query.code)
    {
        ...
        var query = {
            ...
            'redirect_uri': 'https://www.lemonlabs.mx/test'
        };
        ...
        // USER PROFILE
        var userProfileResponse = await fetch(`https://graph.instagram.com/${jsonAccessToken.user_id}?fields=id,username&access_token=${longTokenJson.access_token}`, {
            method: 'GET'
        });
